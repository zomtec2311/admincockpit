OC.L10N.register(
    ...
    "rename group now": "μετονομασία ομάδας τώρα",
    "Group renamed successfully": "Η ομάδα μετονομάστηκε επιτυχώς",
    "Missing group name": "Λείπει όνομα ομάδας",
    "The group name is too long": "Το όνομα της ομάδας είναι πολύ μεγάλο",
